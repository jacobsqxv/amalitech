...
ACCOUNT_ACTIVATION_DAYS = 1  # Number of days before activation key expires
REGISTRATION_AUTO_LOGIN = False  # Disable auto-login after registration
...
# amount of time before verification link expires
EXPIRE_AFTER = '1h'
